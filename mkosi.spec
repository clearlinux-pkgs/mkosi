...
Version  : 14
Release  : 44
URL      : https://github.com/systemd/mkosi/archive/v14/mkosi-14.tar.gz
Source0  : https://github.com/systemd/mkosi/archive/v14/mkosi-14.tar.gz
...
%prep
%setup -q -n mkosi-14
cd %{_builddir}/mkosi-14
pushd ..
cp -a mkosi-14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666896514
