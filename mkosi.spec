...
Version  : 23.1
Release  : 47
URL      : https://github.com/systemd/mkosi/archive/v23.1/mkosi-23.1.tar.gz
Source0  : https://github.com/systemd/mkosi/archive/v23.1/mkosi-23.1.tar.gz
...
%prep
%setup -q -n mkosi-23.1
cd %{_builddir}/mkosi-23.1
pushd ..
cp -a mkosi-23.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719977455
